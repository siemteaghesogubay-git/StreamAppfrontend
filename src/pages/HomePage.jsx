...
const styles = {
  ...
  catBtn: { background: 'transparent', border: '1px solid #333', color: '#888', padding: '8px 20px', borderRadius: 20, cursor: 'pointer', fontSize: 14, transition: 'all 0.15s' },
  ...
  thumbnail: { aspectRatio: '16/9', background: 'linear-gradient(135deg, #1a1a2e, #2d1b69)', display: 'flex', alignItems: 'center', justifyContent: 'center' },
